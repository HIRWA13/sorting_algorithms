 ...
 *@str1: string
 *@str2: string
 *Return: wether 1 str1 and str2 are equal or 0 they are not equal
 */
 ...
 * @node: represent the card entered
 * Return: return the card position of the card entered
 */
...
/**
 *swap_card - swapping a card for its previous one
 *@card: card itself
 *@deck: card's deck
 *Return: return a pointer to a card which was entered in it
 */
...
/**
 * insertion_sort_deck - function for sorting a doubly linked deck
...
/**
 * sort_deck - sorting a deck you entered
